		  ...
		  Column {
				...
				Row {
					...
					Text {
						...
						color: CustStyle.accent_text
						//font.family: Fonts.segoe_ui // requires unicode v10 compatability
      			//font.styleName: "Regualar"
						font.bold: true
						font.pixelSize: CustStyle.fsize_xlarge
						anchors.verticalCenter: parent.verticalCenter

						//debugger:
						// print the raw display string to terminal to check Ansi unicodes.
						// TODO: issue with notary unicodes on windows.
						MouseArea {
							anchors.fill: parent
							hoverEnabled: true
							...
							onClicked: {
								// print raw displayBalnace string to terminal for further review
								console.log("Raw Displaybalance: ", displayBalanceInUnitsText.text)
							}
						}//end 'inputArea'

					}
				}//end 'balanceDisplayRow'
			}//end 'accountSummaryDisplay'
		}//end 'topHeaderElementRow'
